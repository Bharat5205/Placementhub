...
async function seed() {
  try {
    ...
    const companies = [
      ...
      { name: 'Cisco', logo: 'cisco.svg', role: 'Software Engineer', pkg: 18.0, cgpa: 7.5, visit: '2026-08-25', deadline: '2026-08-10', desc: 'Cisco Systems, Inc. is a multinational digital communications technology conglomerate corporation.', hiring: 'Aptitude & Coding OA → Technical Interview 1 → Technical Interview 2 → HR Round' },
